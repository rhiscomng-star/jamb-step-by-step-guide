  ...
  const steps = [
    {
      ...
      videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ?si=placeholder1" // Placeholder video
    },
    {
    ...
    {
      id: StepId.CENTERS,
      title: "4. Accredited Centers 2026",
      description: "Find a verified center near you in your state.",
      icon: <MapPin className="text-green-600" />,
      content: <CenterList />,
      videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ?si=placeholder4"
    }
  ];
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4 backdrop-blur-sm">
          <div className="bg-white w-full max-w-md rounded-3xl p-8 shadow-2xl relative">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-8">This app works on Android & iOS without downloading an APK. Install it directly from your browser!</p>
              ...
              <div className="space-y-4 text-left">
                ...
                <div className="p-4 bg-gray-50 rounded-2xl flex gap-4">
                  ...
                  <p className="text-sm text-gray-700">Tap the <span className="font-bold underline">Menu</span> (3 dots) or <span className="font-bold underline">Share</span> button.</p>
                </div>
                <div className="p-4 bg-gray-50 rounded-2xl flex gap-4">
            ...
            <div className="flex-1 p-4 overflow-y-auto space-y-4 bg-gray-50 min-h-[300px]">
              {chatHistory.length === 0 && (
                <div className="text-center py-8">
                  ...
                  <p className="text-xs text-gray-400 mt-2">Example: "How do I retrieve my lost profile code?"</p>
                </div>
              )}
